...
const SITE = {
  ...
  /* ---------- ROOMS (101~203호) ----------
     ※ 소개/스펙은 임의로 채운 가안입니다. 실제 객실 정보로 교체 필요(클라이언트 확인). */
  rooms: [
    {
      id: 'room-101', label: '101호', en: 'ROOM 101', name: '101호',
      desc: '1층에 자리한 아늑한 원룸형 객실입니다.\n취사가 가능해 가족 단위 여행에 편리합니다.',
      spec: { info: '1층 · 원룸형 · 취사 가능', people: '기준 2인 / 최대 4인', checkin: '15:00 / 11:00' },
    ...
    },
    {
      ...
      desc: '1층 원룸형 객실로, 주차장과 가까워 이동이 편리합니다.\n아이를 동반한 가족 여행에 특히 좋습니다.',
      spec: { info: '1층 · 원룸형 · 취사 가능', people: '기준 2인 / 최대 4인', checkin: '15:00 / 11:00' },
      amenities: ['무선 와이파이', '에어컨', 'TV', '냉장고', '전기포트', '취사도구', '침구 · 수건', '주차'],
    ...
    },
    {
      ...
      desc: '1층 객실 중 넉넉한 구조로, 일행이 많아도 여유롭습니다.\n취사 공간이 분리되어 편안하게 머무를 수 있습니다.',
      spec: { info: '1층 · 원룸형 · 취사 가능', people: '기준 3인 / 최대 5인', checkin: '15:00 / 11:00' },
      amenities: ['무선 와이파이', '에어컨', 'TV', '냉장고', '전기포트', '취사도구', '침구 · 수건', '주차'],
    ...
    },
    {
      ...
      desc: '2층에 위치해 채광과 전망이 좋은 객실입니다.\n조용히 쉬어가기 좋아 커플·가족 모두에게 추천합니다.',
      spec: { info: '2층 · 원룸형 · 취사 가능', people: '기준 2인 / 최대 4인', checkin: '15:00 / 11:00' },
      amenities: ['무선 와이파이', '에어컨', 'TV', '냉장고', '전기포트', '취사도구', '침구 · 수건', '주차'],
    ...
    },
    {
      ...
      desc: '2층에서 가장 넓은 객실로, 단체 여행에 적합합니다.\n넉넉한 공간과 취사 설비를 갖추었습니다.',
      spec: { info: '2층 · 원룸형 · 취사 가능', people: '기준 4인 / 최대 6인', checkin: '15:00 / 11:00' },
      amenities: ['무선 와이파이', '에어컨', 'TV', '냉장고', '전기포트', '취사도구', '침구 · 수건', '주차'],
  ...
  travel: [
    { name: '몽산포해수욕장', time: '차량 5분', dist: '약 2km', desc: '완만한 백사장과 소나무 숲이 어우러진 태안의 대표 해변. 일몰 명소로 유명합니다.', img: PH },
  ...
  guide: {
    ...
    /* ※ 아래 요금·시간·환불 규정은 임의로 채운 가안입니다. 실제 정책으로 교체 필요(클라이언트 확인). */
    checkin: [
      ['입실 시간', '15:00'],
      ['퇴실 시간', '11:00'],
